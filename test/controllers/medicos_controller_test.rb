...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post medicos_url, params: { medico: { cpf: @medico.cpf, dataNascimento: @medico.dataNascimento, email: @medico.email, especialidade: @medico.especialidade, nomeCompleto: @medico.nomeCompleto } }
  #   end
  ...
  #   patch medico_url(@medico), params: { medico: { cpf: @medico.cpf, dataNascimento: @medico.dataNascimento, email: @medico.email, especialidade: @medico.especialidade, nomeCompleto: @medico.nomeCompleto } }
